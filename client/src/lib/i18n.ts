...
const resources = {
  ru: {
    translation: {
      ...
      "analyzing": "Анализируем",
      "qrCode": "QR-код",
      "scanToOpenMenu": "Отсканируйте, чтобы открыть меню",
      "downloadQR": "Скачать QR-код",
      "downloadForPrintPDF": "Скачать для печати (PDF)",
      "howToUseQR": "Использование QR-кода",
      "qrInstructions1Title": "На столах",
      "qrInstructions1Desc": "QR-код распечатать и на каждый стол положить, чтобы гости анкировали",
      "qrInstructions2Title": "В витрине",
      "qrInstructions2Desc": "На входе или в витрине разместить, чтобы привлечь посетителей",
      "qrInstructions3Title": "В соцсетях",
      "qrInstructions3Desc": "В Instagram, Facebook-постах или Website разместить",
  ...
  en: {
    translation: {
      ...
      "howToUseQR": "How to use QR code",
      "qrInstructions1Title": "On tables",
      "qrInstructions1Desc": "Print QR code and place on each table so guests can scan",
      "qrInstructions2Title": "In window",
      "qrInstructions2Desc": "Place at entrance or in window display to attract visitors",
      "qrInstructions3Title": "On social media",
      "qrInstructions3Desc": "Share on Instagram, Facebook posts or website",
  ...
  de: {
    translation: {
      ...
      "qrCode": "QR-Code",
      "scanToOpenMenu": "Scannen Sie, um das Menü zu öffnen",
      "downloadQR": "QR-Code herunterladen",
      "downloadForPrintPDF": "Für Druck herunterladen (PDF)",
      "howToUseQR": "QR-Code verwenden",
      "qrInstructions1Title": "Auf Tischen",
      "qrInstructions1Desc": "QR-Code drucken und auf jeden Tisch legen, damit Gäste scannen können",
      "qrInstructions2Title": "Im Schaufenster",
      "qrInstructions2Desc": "Am Eingang oder im Schaufenster platzieren, um Besucher anzulocken",
      "qrInstructions3Title": "In sozialen Medien",
      "qrInstructions3Desc": "Auf Instagram-, Facebook-Posts oder Website teilen",
